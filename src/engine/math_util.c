...
ALWAYS_INLINE void mtxf_quat_trans_mul(s16 *rot, Vec3f trans, Mat4 dest, Mat4 src) {
    f32 Quaternion[4];
    f32 QuaternionSquare[4];
    f32 entry[3];
    Quaternion[0] = rot[0] / 32767.f;
    Quaternion[1] = rot[1] / 32767.f;
    Quaternion[2] = rot[2] / 32767.f;
    Quaternion[3] = rot[3] / 32767.f;
    // QuaternionSquare[0] = sqr(Quaternion[0]);
    QuaternionSquare[1] = sqr(Quaternion[1]);
    QuaternionSquare[2] = sqr(Quaternion[2]);
    QuaternionSquare[3] = sqr(Quaternion[3]);

    entry[0] = -2.f * (QuaternionSquare[2] + QuaternionSquare[3]) + 1.f;
    entry[1] = 2.f * (Quaternion[1] * Quaternion[2] - Quaternion[0] * Quaternion[3]);
    entry[2] = 2.f * (Quaternion[1] * Quaternion[3] + Quaternion[0] * Quaternion[2]);
    ...
    entry[0] = 2.f * (Quaternion[1] * Quaternion[2] + Quaternion[0] * Quaternion[3]);
    entry[1] = -2.f * (QuaternionSquare[1] + QuaternionSquare[3]) + 1.f;
    entry[2] = 2.f * (Quaternion[2] * Quaternion[3] - Quaternion[0] * Quaternion[1]);
    ...
    entry[0] = 2.f * (Quaternion[1] * Quaternion[3] - Quaternion[0] * Quaternion[2]);
    entry[1] = 2.f * (Quaternion[2] * Quaternion[3] + Quaternion[0] * Quaternion[1]);
    entry[2] = -2.f * (QuaternionSquare[1] + QuaternionSquare[2]) + 1.f;
